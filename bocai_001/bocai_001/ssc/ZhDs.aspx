<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhDs.aspx.cs" Inherits="bocai_001.ssc.ZhDs" %>
...
<head runat="server">
    ...
    <a class="Refresh" href="ZhDs.Aspx?P=5&amp;Cid=<%=_Uid %>&amp;v=1&amp;Nc=55287">刷新</a><br></div><div class="number">上期开奖：<%=_result %></div></div><hr/><strong>所有游戏下注后都不能撤单，请所有玩家下注时看好了再确认下注。</strong><br>
<asp:MultiView ID="MultiView1" runat="server">  
   ...
   <form method="post" name="form1" action="ZhDs.Aspx?Cid=<%=_Uid %>&amp;v=1&amp;Ac=Bet">
    <div class="write">
    ...
    <asp:View ID="View2" runat="server">
       <form method="post" action="ZhDs.aspx?Cid=<%=_Uid %>&amp;v=2&amp;Ac=Bet">
        总和单双:<%=_a %><br />下注金额:<%=_b %>币,需要<%=_b %>币<br />
