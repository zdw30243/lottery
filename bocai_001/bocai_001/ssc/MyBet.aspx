<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyBet.aspx.cs" Inherits="bocai_001.ssc.MyBet" %>
...
<body>
    <div class="szc">昵称:<strong><%=_netNameLink %></strong>❀<a href="/View/View.Aspx?id=25&amp;Cid=<%=_Uid %>&amp;v=1">[充值]</a>
        ...
        <%=_result %>
        <a href="/ssc/MyBet.Aspx?&amp;Cid=<%=_Uid %>&amp;v=1&amp;page=<%=_pageNext %>">[下页]</a><%=_previousPage %><br />共有<%=_totalPiece %>条记录,当前<%=_currentPage %>/<%=_totalPage %>页<br/>
    <form id="form3" runat="server" method="get" action="/ssc/MyBet.Aspx">
        <asp:TextBox ID="page" runat="server"  size="3" MaxLength ="9"></asp:TextBox><br/>
