<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhDx.aspx.cs" Inherits="bocai_001.ssc.ZhDx" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <p class="login1"><%=_login1 %></p>
       ...
       <!--#include file="/nameAndMoney.html"-->
        ...
        当前期数:<%=currentQishu %><br><div class="stoptime"><div>本期截止:<span id="stoptime">10分28秒</span></div><script>
    ...
    <a class="Refresh" href="ZhDx.Aspx?Cid=<%=_Uid %>&amp;v=1&amp;Nc=55287">刷新</a><br></div><div class="number">上期开奖：<%=_result %></div></div><hr/><strong>所有游戏下注后都不能撤单，请所有玩家下注时看好了再确认下注。</strong><br>
<asp:MultiView ID="MultiView1" runat="server">  
   ...
   <form method="post" name="form1" action="ZhDx.Aspx?Cid=<%=_Uid %>&amp;v=1&amp;Ac=Bet">
    <div class="write">
    ...
    <asp:View ID="View2" runat="server">
       <form method="post" action="ZhDx.aspx?Cid=<%=_Uid %>&amp;v=2&amp;Ac=Bet">
        总和大小:<%=_a %><br />下注金额:<%=_b %>币,需要<%=_b %>币<br />
