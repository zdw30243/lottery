<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RxDs.aspx.cs" Inherits="bocai_001.ssc.RxDs" %>
...
<form id="form1" runat="server">
    ...
    <a class="Refresh" href="RxDs.Aspx?P=<% =_P %>&amp;Cid=<%=_Uid %>&amp;v=1&amp;Nc=55287">刷新</a><br></div><div class="number">上期开奖：<%=_result %></div></div><hr /><strong>所有游戏下注后都不能撤单，请所有玩家下注时看好了再确认下注。</strong><br />
<asp:MultiView ID="MultiView1" runat="server">  
   ...
   <form method="post" name="form1" action="RxDs.Aspx?Cid=<%=_Uid %>&amp;P=<% =_P %>&amp;v=1&amp;Ac=Bet">
    <div class="write">
    ...
    <asp:View ID="View2" runat="server">
       <form method="post" action="RxDs.aspx?Cid=<%=_Uid %>&amp;P=<%=_P %>&amp;v=2&amp;Ac=Bet">
